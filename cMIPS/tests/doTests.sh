...
while true ; do
    ...
    case "$1" in
        ...
        -B) ignBLANKS="-B"
            ;;
        -C | -Comp | -Compile | -compile ) recompile=true
            ;;
        #-c) withCache=true
        #    ;;
...
sed -i -e '/define TLB_MODIFIED/s:1:0:' -e '/define DOUBLE_FAULT/s:1:0:' \
    -e '/define PROT_VIOL/s:1:0:' -e '/define PROT_VIOL/s:1:0:' pt_walk.c
